...
module.exports = {
    ...
    deploy: {
        development: {
            ...
            "post-setup": "pwd",
            'pre-deploy-local': '',
            'post-deploy': 'ls -la && npm install && pm2 startOrRestart ecosystem.config.js --only "web-development,api-development" --env development',
        },
        test: {
            ..._deploy_linuxlei,
            ref: 'origin/test',
            ...
            "post-setup": "pwd",
            'pre-deploy-local': '',
            'post-deploy': "ls -la && npm install && pm2 startOrRestart ecosystem.config.js --only 'web-test,api-test' --env test",
        },
        production: {
            ..._deploy_linuxlei,
            ...
            "post-setup": "pwd",
            'pre-deploy-local': '',
            'post-deploy': 'ls -la && npm install && pm2 startOrRestart ecosystem.config.js --only "web-production,api-production" --env production',
        },
    },
};
